...
public class InvocationExpectationTests extends TestCase {
    ...
    public void testIsHistoric() throws Throwable {
        expectation.setCardinality(Cardinality.between(0, Integer.MAX_VALUE));
        assertFalse(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(0, 0));
        assertFalse(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(1, 1));
        assertFalse(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(1, Integer.MAX_VALUE));
        assertFalse(expectation.isHistoric());
        ...
        assertFalse(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(1, 1));
        assertTrue(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(1, Integer.MAX_VALUE));
        assertFalse(expectation.isHistoric());
        expectation.setCardinality(Cardinality.between(2, 3));
        assertFalse(expectation.isHistoric());
